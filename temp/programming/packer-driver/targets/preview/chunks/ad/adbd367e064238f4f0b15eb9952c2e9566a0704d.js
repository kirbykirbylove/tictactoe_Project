System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "21b11vnhApDJJxLBTaZcrk/", "GameManager", undefined);
      ...
      _export("TicTacToeGame", TicTacToeGame = (_dec = ccclass('TicTacToeGame'), _dec2 = property(Node), _dec3 = property(Button), _dec4 = property(Label), _dec5 = property(SpriteFrame), _dec6 = property(SpriteFrame), _dec7 = property(SpriteFrame), _dec8 = property(Sprite), _dec(_class = (_class2 = class TicTacToeGame extends Component {
        ...
        setupEventListeners() {
          ...
          var _loop = function _loop(i) {
            var button = _this.gridButtons[i];
        ...
        getBestMove() {
          ...
          var useMinimax = Math.random() < 0.7;

          if (useMinimax) {
            var bestScore = -Infinity;
            var bestMove = -1;

            for (var _i of emptyIndices) {
              this.board[_i] = CellState.AI;
...
//# sourceMappingURL=adbd367e064238f4f0b15eb9952c2e9566a0704d.js.map